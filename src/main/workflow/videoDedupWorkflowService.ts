  ...
  switch (normalized) {
    case "fidelity-light":
      return {
        ...
        label: "保真轻去重",
        filters: [
          "crop=iw*0.989:ih*0.989:(iw-ow)/2+sin(t*0.37)*1.2:(ih-oh)/2+cos(t*0.31)*1.2",
          "rotate=0.0012*sin(t*0.42):fillcolor=black@0",
          "lenscorrection=k1=0.003:k2=-0.001",
          "crop=iw*0.998:ih*0.998:(iw-ow)/2:(ih-oh)/2",
          "eq=saturation=1.025:contrast=1.018:brightness=0.003",
          "noise=alls=1:allf=t+u",
          "fps=30000/1001"
        ],
        audioFilter: "volume=0.988,highpass=f=28,lowpass=f=16800",
        crf: "21",
        gop: "53",
        preset: "veryfast",
        baseScore: 74,
    ...
    case "pixel-remix":
      return {
        ...
        label: "深度像素重塑",
        filters: [
          "crop=iw*0.958:ih*0.958:(iw-ow)/2+sin(t*0.69)*3.4:(ih-oh)/2+cos(t*0.53)*3.0",
          "scale=trunc(iw*1.018/2)*2:trunc(ih*1.018/2)*2",
          "rotate=0.0038*sin(t*0.48):fillcolor=black@0",
          "perspective=x0=3:y0=2:x1=W-4:y1=1:x2=1:y2=H-3:x3=W-3:y3=H-2:interpolation=linear",
          "lenscorrection=k1=0.012:k2=-0.006",
          "crop=iw*0.992:ih*0.992:(iw-ow)/2:(ih-oh)/2",
        ...
        audioFilter: "volume=0.968,highpass=f=32,lowpass=f=15400,aecho=0.8:0.88:18:0.018",
        crf: "22",
        gop: "41",
        preset: "veryfast",
        baseScore: 88,
    ...
    default:
      return {
        ...
        label: "保真强去重",
        filters: [
          "crop=iw*0.974:ih*0.974:(iw-ow)/2+sin(t*0.52)*2.4:(ih-oh)/2+cos(t*0.47)*2.0",
          "scale=trunc(iw*1.012/2)*2:trunc(ih*1.012/2)*2",
          "rotate=0.0024*sin(t*0.46):fillcolor=black@0",
          "perspective=x0=2:y0=1:x1=W-3:y1=1:x2=1:y2=H-2:x3=W-2:y3=H-1:interpolation=linear",
          "lenscorrection=k1=0.007:k2=-0.003",
          "crop=iw*0.995:ih*0.995:(iw-ow)/2:(ih-oh)/2",
          "eq=saturation=1.04:contrast=1.032:brightness=0.004",
          "noise=alls=2:allf=t+u",
          "unsharp=3:3:0.28:3:3:0.0",
          "fps=30000/1001"
        ],
        audioFilter: "volume=0.978,highpass=f=30,lowpass=f=16000",
        crf: "22",
        gop: "47",
        preset: "veryfast",
        baseScore: 82,
